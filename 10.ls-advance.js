...
const folder = process.argv[2] ?? '.'; //Por defecto que sea el punto


async function ls (folder){
    let files 
try{
    files = await fs.readdir(folder);//Tenemos que leer los archivos del directorio antes de continuar con el codigo
}catch{
